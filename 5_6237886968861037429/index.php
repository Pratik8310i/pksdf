...
<input type="text" id="pkkey" class="form-control text-center" placeholder="Enter Payment Key (PK)"><br>
            ...
            $(document).ready(function () {
                ...
                $('.btn-play').click(function () {
                    ...
                    line.forEach(function (data) {
                        var callBack = $.ajax({
                            url: 'api.php?lista=' + data + '&skkey=' + skkey + '&pkkey=' + pkkey,
